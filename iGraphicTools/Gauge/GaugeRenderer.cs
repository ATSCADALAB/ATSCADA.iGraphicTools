...
namespace ATSCADA.iGraphicTools.Gauge
{
	public class GaugeRenderer
	{
		...
		/// Control to render
		/// </summary>
		private iGauge meter = null;
		#endregion

		#region Properies
		public iGauge AnalogMeter
		{
		...
		public virtual bool DrawThresholds(Graphics Gr, RectangleF rc)
		{
			...
			foreach (GaugeThreshold sect in this.AnalogMeter.Thresholds)
			{
		...
		public virtual bool DrawDivisions(Graphics Gr, RectangleF rc)
		{
			...
			for (; n < scaleDivisions; n++)
			{
				...
				//Draw Strings
				Font font = new Font(this.AnalogMeter.Font.FontFamily, (float)(12F * drawRatio));
