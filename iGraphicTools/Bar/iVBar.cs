...
namespace ATSCADA.iGraphicTools.Bar
{
    ...
    public partial class iVBar : UserControl
    {
        ...
        {
            var heightOfBackground = this.pnlFill.Height / 2;
            this.SynchronizedInvokeAction(() => this.pnlBackground.Height = heightOfBackground);
        }
        ...
        private void Driver_ConstructionCompleted()
        {
            ...
            this.gain = (this.pnlFill.Height) / (this.maxValue - this.minValue);
        ...
        private void UpdateGraphic(string value)
        {
            ...
            {
                if (InverseDirect) this.pnlBackground.Height = heightOfBar;
                else
                    this.pnlBackground.Height = this.pnlFill.Height - heightOfBar > 0 ?
                    this.pnlFill.Height - heightOfBar :
                    0;
            });
        }
